    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="tickets.Board"
            ),
        ),
        migrations.AddField(
            model_name="ticket",
            name="source",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="tickets.Source"
            ),
        ),
        migrations.AddField(
            model_name="ticket",
        ...
        migrations.AlterUniqueTogether(
            name="ticket", unique_together={("external_id", "source")}
        ),
    ]
